...
It appears that Hispanic/Latino individuals, armed or not, experienced the highest rates of death by gunshot (aside from the Unknown race category, but that's hard to interpret). We do see that Black individuals die by gunshot at higher rates when they're not lethally armed than when they're armed with a lethal firearm, which suggests some support for my hypothesis but cannot be interpreted as causal without a regression model.
