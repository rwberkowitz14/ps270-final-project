...
Our independent variables are race/ethnicity of deceased, whether victim was armed, and racial demographic of the relevant tract (specifically for our case, percent of population that is Black). The dependent variable we're measuring is the cause of death, specifically gunshot or non-gunshot. The data is cross-sectional.
